...
def objective(trial):
    ...
    return accuracy,flops,train_time
...
if algorithm in ["qehvi","parego"]:
    ...
    study = optuna.multi_objective.create_study(["maximize","minimize","minimize"], sampler=RandomMultiObjectiveSampler())
...
for trial in trials:
    ...
    result["train_time"] = trial.values[2]
