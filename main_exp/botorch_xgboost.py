...
seed = seeds[0]
path = "./results/{data}/seed-{seed}_algorithm-{algorithm}/".format(data = data, seed = seed, algorithm = algorithm)
...
trials = sorted(study.best_trials, key=lambda t: t.user_attrs["wall_clock_time"])
result_all = {}
index = 0j
for trial in trials:
    result = {}
